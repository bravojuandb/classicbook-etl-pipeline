...
for Book IV of the Imitation of Christ:
...
INPUT_PATH = BASE_DIR / 'processed_data' / 'aligned' / 'book4_aligned.tsv'
OUTPUT_PATH = BASE_DIR / 'processed_data' / 'cleaned' / 'book4_cleaned.tsv'
...
df.insert(1, "book", ["Book IV"] * len(df))
