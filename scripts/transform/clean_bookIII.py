...
for Book III of the Imitation of Christ:
...
INPUT_PATH = BASE_DIR / 'processed_data' / 'aligned' / 'book3_aligned.tsv'
OUTPUT_PATH = BASE_DIR / 'processed_data' / 'cleaned' / 'book3_cleaned.tsv'
...
df.insert(1, "book", ["Book III"] * len(df))
