...
for Book I of the Imitation of Christ:
...
INPUT_PATH = BASE_DIR / 'processed_data' / 'aligned' / 'book1_aligned.tsv'
OUTPUT_PATH = BASE_DIR / 'processed_data' / 'cleaned' / 'book1_cleaned.tsv'
...
df.insert(1, "book", ["Book I"] * len(df))
